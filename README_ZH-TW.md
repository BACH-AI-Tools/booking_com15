...
4. 🔍 搜尋或找到本伺服器（`bach-booking_com15`）
5. 🎉 點擊 **「安裝 MCP」** 按鈕
6. ✅ 完成！即可在您的應用中使用
...
這是一個使用 [FastMCP](https://fastmcp.wiki) 自動生成的 MCP 伺服器，用於存取 Booking Com15 API。

- **PyPI 套件名**: `bach-booking_com15`
- **版本**: 1.0.0
- **傳輸協定**: stdio
...
**注意**: 請將 `E:\path\to\booking_com15\server.py` 替換為實際的伺服器檔案路徑。
